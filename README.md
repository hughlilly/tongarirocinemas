...
1. View information on the history of the cinema, and on its rewards programme (**About** and **Rewards** pages)

## Source and running locally

The source code for the site is in the `/src` directory.
